...
CSV_FIRST  = BASE_DIR / "logpal_2023_first_eng_scores_chu2.csv"
CSV_SECOND = BASE_DIR / "logpal_2023_second_eng_scores_chu2.csv"
MAPPING_CSV = BASE_DIR / "student_id_mapping.csv"

OUTPUT_CSV  = BASE_DIR / "logpalette_2023_chu2_english_with_ids.csv"
...
def main():
    ...
    print("\n=== Scores dataframe summary (2023 中2) ===")
